...
@if (session('status'))
  ...
  <div class="flex items-center">
    ...
    <h3 class="text-lg font-medium">Curso Eiminido</h3>
  </div>
...
@endif
    ...
    <ul>
        @foreach ($cursos as $curso)
            <li class="decoration-pink-500 no-underline hover:underline ..."> <a href="{{ route('cursos.show', $curso) }}">{{ $curso->nombre }}</a> </li>
